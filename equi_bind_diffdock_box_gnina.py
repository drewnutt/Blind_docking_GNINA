...
if normal_pocket:
    output_path = os.path.join(args.results_path, mode+'_'+sf+"_diffdock_box_pdbqt_vina_seed"+str(seed) +"_normal"+str(pocket_size))
else:
    output_path = os.path.join(args.results_path, mode+'_'+sf+"_diffdock_box_pdbqt_vina_seed"+str(seed))
